...
**관련 운영 룰 (2026-05-04 결정 — 옵션 D)**:
- **케이스 1개 = 1국가**. case.country는 단일 국가 코드 (US/KR/JP/EU/MX/AR/CO/CL/PE/BR/SG/TH/MY/ID/PH/VN/AE/SA/…)
- 권역(LATAM_ES/LATAM_BR/SEA/MENA)은 view 단위. 정적 매핑은 [src/lib/case-detail/countries.ts](src/lib/case-detail/countries.ts)
- contents/sales 자식 테이블의 country도 case.country (= 진짜 국가 코드) 그대로 박힘
- 케이스 단위 분석 = 단일 국가라 명확. "사우디 특이사항" = SA case, "UAE 특이사항" = AE case
- 권역 통합 view는 이 페이지에서 처리:
